function branch_export_old() {
	...
	fn = string(get_save_filename_ext(localize_ko("Minecraft Schematics (*.schematic)|*.schematic"), filename_new_ext(songs[song].filename, ""), "", localize_ko("Export Schematic")))
	if (fn = "") return 0
