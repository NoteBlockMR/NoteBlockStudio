function draw_window_clip_editor() {
	...
	if (language != 1) draw_text_dynamic(x1 + 8, y1 + 8, localize_ko("Secret Clipboard Editor"))
	...
	draw_theme_color()
	if (language != 1) draw_areaheader(x1 + 22, y1 + 48, 396, 330, localize_ko("Clipboard"))
	...
	if (draw_button2(x1 + 320, y1 + 398, 72, condstr(language != 1, localize_ko("OK"), "确定")) && (windowopen = 1 || theme != 3)) {
		windowclose = 1
	}
