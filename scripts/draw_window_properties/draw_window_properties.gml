function draw_window_properties() {
	...
	a = song_name
	if (language != 1) song_name = draw_inputbox(1, x1 + 158, y1 + 64, 240, song_name, localize_ko("The name of the song."))
	...
	a = song_author
	if (language != 1) song_author = draw_inputbox(2, x1 + 158, y1 + 64 + 23, 240, song_author, localize_ko("The name of the creator of the song."))
	...
	a = song_orauthor
	if (language != 1) song_orauthor = draw_inputbox(3, x1 + 158, y1 + 64 + 23 * 2, 240, song_orauthor, localize_ko("The name of the creator of the original song\n(Leave empty if you composed the song yourself.)"))
	...
	a = song_desc
	if (language != 1) song_desc = draw_textarea(4, x1 + 158, y1 + 64 + 23 * 3, 240, 100, song_desc, localize_ko("Enter a description for your song."))
	...
	a = loop
	if (language != 1) {if (draw_checkbox(x1 + 252, y1 + 285, loop, localize_ko("Enable looping"), localize_ko("Whether to loop this song back to")+br+localize_ko("the start at the end of playback."), false, true)) loop=!loop}
	...
	if (language != 1) {if (loopmax = 0) draw_text_dynamic(x1 + 360, y1 + 345, localize_ko("(infinite)"))}
