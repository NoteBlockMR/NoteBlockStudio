function draw_window_minecraft() {
	...
	if (selected_tab_mc = 0) { // Schematic
		...
		if (tempo = 10 || tempo = 5 || tempo = 2.5) {
		    ...
		    if (language != 1) draw_text_dynamic(x1 + 45, yy + 16, localize_ko("The tempo is ") + string(tempo) + localize_ko(" ticks per second."))
		...
		if (block_outside > 0) {
		    ...
		    if (block_outside = 1) {
		        ...
		        draw_text_dynamic(x1 + 45, yy + 16, localize_ko("There are ") + string(block_outside) + localize_ko(" blocks outside the 2 octave range."))
		    }
		...
		if (block_custom > 0) {
		    draw_set_color(c_red)
		    if (block_custom = 1) draw_text_dynamic(x1 + 45, yy + 16, localize_ko("There is 1 block with custom instruments."))
		    else draw_text_dynamic(x1 + 45, yy + 16, localize_ko("There are ") + string(block_custom) + localize_ko(" blocks with custom instruments."))
		...
		if (tempo = 20 || tempo = 10 || tempo = 5 || tempo = 4 || tempo = 2.5 || tempo = 2 || tempo = 1.25 || tempo = 1 || tempo = 0.5 || tempo = 0.25) {
			...
			draw_set_color(c_green)
			if (theme == 2 || (theme == 3 && fdark)) draw_set_color(c_lime)
			if (language != 1) draw_text_dynamic(x1 + 45, yy + 32, localize_ko("The tempo is ") + string(tempo) + localize_ko(" ticks per second."))
		...
		if (theme != 3) {
		    ...
		    if (block_outside = 1) {
		        ...
		        if (language != 1) draw_text_dynamic(x1 + 45, yy + 32, localize_ko("There are ") + string(block_outside) + localize_ko(" blocks outside the 2 octave range."))
		...
		if (block_custom > 0) {
		    ...
		    draw_set_color(c_orange)
		    if (block_custom = 1) draw_text_dynamic(x1 + 45, yy + 32, localize_ko("There is 1 block with custom instruments."))
		    else draw_text_dynamic(x1 + 45, yy + 32, localize_ko("There are ") + string(block_custom) + localize_ko(" blocks with custom instruments."))
