function open_song_nbs(fn, sounds_path = "", safeopen) {
	...
	if (byte1 = 0 && byte2 = 0) {
		...
		if (language != 1) {if (show_oldwarning && song_nbs_version < nbs_version) message(localize_ko("Warning: You are opening an older NBS file. Saving this file will make it incompatible with older Note Block Studio versions."),localize_ko("Warning"))}
		...
		if (language != 1) {if (show_oldwarning) message(localize_ko("Warning: You are opening an older NBS file. Saving this file will make it incompatible with older Note Block Studio versions."),localize_ko("Warning"))}
