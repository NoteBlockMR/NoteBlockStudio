function draw_window_macro_stereo() {
	...
	draw_text_dynamic(x1 + 8, y1 + 8, localize_ko("Stereo"))
	...
	if (language != 1) {
	if (draw_checkbox(x1 + 10, y1 + 30, stereo_reverse, localize_ko("Reversed"), localize_ko("Stereo is done in the inverse direction."))) stereo_reverse=!stereo_reverse
	draw_areaheader(x1 + 10, y1 + 53, 120, 35, localize_ko("Stereo width"))
	} else {
